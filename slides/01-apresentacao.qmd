---
title: "Análise de Dados Criminais usando `R`"
subtitle: "Aula 01 - Conhecendo a ferramenta"
format: 
  revealjs:
    incremental: true   
    logo: "http://www.fflch.usp.br/sites/fflch.usp.br/files/2019-04/06_fflch_simbolo.png"
    footer: "Slides por [Artur Damião](https://arturdamiao.com), feitos com [Quarto](https://quarto.org/docs/presentations/revealjs/index.html). Licença de uso: [CC-BY-SA](https://arturdamiao.com/license/)."
    theme: ["custom.scss"]
    slide-number: c/t
...
- [Artur Damião](https://arturdamiao.com/about/)
...
- Hiperfoco em `R` e programação para as ciências sociais.
...
**RStudio** é uma IDE (*integrated development environment*) baseado em Linguagem R, ou seja, um ambiente de desenvolvimento que utilizamos para editar e executar os códigos em R.

### RStudio Cloud?

É a IDE RStudio que podemos utilizar via navegador (sem que seja necessário instalar nada).
...
## Por quê usar linguagens de programação no trabalho? {.middle .center}
...
## O que significa ser código aberto e software livre? {.smaller}
...
<img src="../images/ciclo-ciencia-de-dados.png" style="display: block; margin-left: auto; margin-right: auto;"/>
...
<img src="../images/ciclo-ciencia-de-dados-pacotes.png" style="display: block; margin-left: auto; margin-right: auto;"/>
...
# Por que isso é importante? {.middle .center}
...
## Como desativar?^[Atenção: se você nunca usar, nem vai sentir falta!] {.nonincremental .smaller}
...
> Se a sua primeira linha do seu Script é

```{r}
#| eval: false
#| echo: true
setwd("C:/Users/artur/caminho/que/só/voce/tem")
```

> Eu irei até a sua casa e colocarei FOGO no seu computador 🔥

> Se a segunda linha do seu script for
...
### Caminhos absolutos e relativos {.smaller}
...
## Projetos no RStudio: o `.RProj` {.middle .center}
